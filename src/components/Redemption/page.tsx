        ...
        <div className="bg-[#0b3c26] p-10 sm:p-5">
            <Container>
                ...
                <div className="bg-[#0b3c26] p-10 border rounded-lg items-center shadow-2xl shadow-black border-none ">
                    ...
                    <h1 className="text-white text-[25px] font-normal my-10">Поможем зарегистрироваться на нужном сайте
                        , найти
                    ...
                    lg:flex-row lg:items-center">
                        <div
                            ...
                            <div>
                                <h1 className="text-white text-[30px] font-semibold mb-2 lg:text-[25px]">Без знания
                                    китайского</h1>
                                <p className="text-white font-normal font-sans text-[18px] sm:text-[15px]">Поможем
                                    оформить заказ.
                                    заполнить <br/>
                    ...
                    lg:flex-row lg:text-left">
                            ...
                            <div>
                                <h1 className="text-white text-[30px] font-semibold mb-2 lg:text-[25px]">Доставим за
                                    7-12 дней <br/>
                                    со дня поступления на склад в Китае</h1>
                                <p className="text-white font-normal font-sans text-[18px] sm:text-[15px]">Более 90 %
